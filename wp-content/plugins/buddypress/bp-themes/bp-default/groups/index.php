...
get_header( 'buddypress' ); ?>
	...
	<div id="content">
		...
		<form action="" method="post" id="groups-directory-form" class="dir-form">
			...
			<h3><?php _e( 'Groups Directory', 'buddypress' ); ?><?php if ( is_user_logged_in() && bp_user_can_create_groups() ) : ?> &nbsp;<a class="button" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() . '/create' ); ?>"><?php _e( 'Create a Event', 'buddypress' ); ?></a><?php endif; ?></h3>
